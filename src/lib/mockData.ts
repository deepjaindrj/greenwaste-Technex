...
export const aiInsights = [
  { id: 1, title: 'Zone 4-B Overflow Risk', priority: 'high', description: 'Predicted overflow by Saturday. Recommend 2 additional pickups for the Andheri West area.', savings: '₹12,000/month', co2: '−180 kg CO₂' },
...
export const municipalData = {
  ...
  alerts: [
    { type: 'overflow', title: 'Overflow Alert — Zone 4B', location: 'Andheri West', time: '5 min ago' },
    { type: 'segregation', title: 'Low Segregation — Ward 12', location: 'Dadar', time: '12 min ago' },
    { type: 'delay', title: 'Route Delay — Truck MH-247', location: 'Bandra', time: '18 min ago' },
    { type: 'milestone', title: 'Milestone — Ward 3 hit 80%', location: 'Colaba', time: '1 hr ago' },
    { type: 'overflow', title: 'Overflow Risk — Zone 7A', location: 'Powai', time: '2 hr ago' },
  ],
  trucks: [
    { id: 'MH-201', zone: 'Zone 1', status: 'Active', collected: '4.2t' },
    { id: 'MH-215', zone: 'Zone 3', status: 'Active', collected: '3.8t' },
    { id: 'MH-247', zone: 'Zone 4', status: 'Delayed', collected: '2.1t' },
    { id: 'MH-289', zone: 'Zone 6', status: 'Idle', collected: '0t' },
    { id: 'MH-302', zone: 'Zone 7', status: 'Active', collected: '5.1t' },
  ],
  forecast: [
...
export const leaderboardData = [
  { rank: 1, name: 'Priya Sharma', society: 'Green Valley Apts', city: 'Mumbai', points: 24800, trend: [40, 45, 50, 55, 60, 65, 72], badge: '🥇' },
  { rank: 2, name: 'Rahul Desai', society: 'EcoNest Society', city: 'Pune', points: 22150, trend: [35, 38, 42, 50, 55, 58, 64], badge: '🥈' },
  { rank: 3, name: 'Sneha Kulkarni', society: 'SunRise Tower', city: 'Mumbai', points: 19400, trend: [30, 35, 40, 42, 48, 52, 58], badge: '🥉' },
  { rank: 4, name: 'Vikram Joshi', society: 'Park View', city: 'Delhi', points: 17650, trend: [28, 32, 38, 40, 44, 48, 53], badge: '' },
  { rank: 5, name: 'Arjun Mehta', society: 'Harmony Heights', city: 'Mumbai', points: 12450, trend: [20, 25, 30, 35, 38, 42, 48], badge: '', isUser: true },
  { rank: 6, name: 'Meera Iyer', society: 'Lake Side Homes', city: 'Bangalore', points: 11200, trend: [18, 22, 28, 32, 36, 38, 44], badge: '' },
  { rank: 7, name: 'Amit Patel', society: 'Royal Gardens', city: 'Ahmedabad', points: 10800, trend: [15, 20, 24, 28, 32, 36, 40], badge: '' },
  { rank: 8, name: 'Kavita Nair', society: 'Ocean Breeze', city: 'Mumbai', points: 9500, trend: [12, 18, 22, 26, 30, 34, 38], badge: '' },
];
...
export const recentReports = [
  ...
  { name: 'Mumbai Q1 Report', type: 'Municipal', date: 'Feb 25, 2026', status: 'Generated' },
